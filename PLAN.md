...
**Filed:** 2026-09-02 · **Status:** M1-M4 done, public 2026-09-13 · **Stage:** beta — the build is in [`build-version.json`](build-version.json)
...
- **Versioning:** `build-version.json` string form (zbump-compatible), alpha
  `v0.0.0.1.x`, annotated tag per release. No committed zip: npm is the
  distributable, and an extracted archive would not run without a build.
...
| **M4** | Ship | docs, `npx` install path, public repo, announcement |
